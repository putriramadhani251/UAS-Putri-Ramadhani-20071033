  ...
  <div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
      <div class="d-flex justify-content-between align-items-center">
        <div class="logo">
          <a href="/" class="d-flex align-items-center justify-content-center"><img src="{{ asset('assets/compiled/svg/favicon.svg') }}" srcset="" alt="Logo" /><span class="fs-5" style="line-height: 0.8">Putri Ramadhani</span></a>
        </div>
    ...
    <div class="sidebar-menu">
      <ul class="menu">
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="/bagianputri">
            <i class="bi bi-grid-fill"></i>
            <span>Bagian</span>
          </a>
        </li>
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="/barangputri">
            <i class="bi bi-grid-fill"></i>
            <span>Barang</span>
          </a>
        </li>
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="/petugasputri">
            <i class="bi bi-grid-fill"></i>
            <span>Petugas</span>
          </a>
        </li>
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="/pengeluaranputri">
            <i class="bi bi-grid-fill"></i>
        ...
        <li class="sidebar-item">
          <a class="sidebar-link" href="/pengeluaranitemputri">
            <i class="bi bi-grid-fill"></i>
